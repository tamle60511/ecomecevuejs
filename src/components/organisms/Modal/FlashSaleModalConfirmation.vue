                ...
                <div class="Wrap relative w-full overflow-x-auto">
                  <table class="Table w-full table-auto">
                    ...
                    <thead class="TableHead w-full rounded-lg bg-[#FAFAFA] 2xl:rounded-large">
                      <tr>
                        <th
                          class="max-w-[200px] whitespace-nowrap px-6 py-3 text-left uppercase text-netral-50 first:pl-3 2xl:py-3.5"
                        >
                          <Body size="lg" weight="medium"> Product </Body>
                        </th>

                        <th
                          class="max-w-[100px] whitespace-nowrap px-6 py-3 text-left uppercase text-netral-50 first:pl-3 2xl:py-3.5"
                        >
                        ...
                        <th
                          class="max-w-[140px] whitespace-nowrap px-6 py-3 text-left uppercase text-netral-50 first:pl-3 2xl:py-3.5"
                        >
                        ...
                        <th
                          class="max-w-[70px] whitespace-nowrap px-6 py-3 text-left uppercase text-netral-50 first:pl-3 2xl:py-3.5"
                        >
                    ...
                    <tbody class="TableBody relative w-full">
                      ...
                      >
                        <td
                          class="max-w-[200px] py-3.5 px-6 text-left capitalize text-netral-80 first:pl-3"
                        >
                        ...
                        <td
                          class="max-w-[100px] py-3.5 px-6 text-left capitalize text-netral-80 first:pl-3"
                        >
                        ...
                        <td
                          class="max-w-[140px] py-3.5 px-6 text-left capitalize text-netral-80 first:pl-3"
                        >
                          <Body size="lg" weight="medium"> {{ product.category }} </Body>
                        </td>
                        ...
                        <td
                          class="max-w-[70px] py-3.5 px-6 text-left capitalize text-netral-80 first:pl-3"
                        >
                          <button
